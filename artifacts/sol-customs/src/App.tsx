...
import heroImg from "@assets/703570652_2220955232006862_7364107803220806714_n_1779909513209.jpg";
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="aspect-square md:aspect-[4/3] rounded-2xl overflow-hidden relative border border-border">
              <img src={gallery9} alt="Premium wrap details" className="w-full h-full object-cover grayscale opacity-80 hover:grayscale-0 hover:opacity-100 transition-all duration-700" />
