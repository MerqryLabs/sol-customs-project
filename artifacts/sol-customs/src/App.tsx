        ...
        <div className="flex items-center justify-between h-20 overflow-hidden">
          <button onClick={() => scrollTo("home")} className="flex items-center gap-4 group">
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="text-[26px] text-primary drop-shadow-[0_0_8px_rgba(179,30,60,0.6)] group-hover:drop-shadow-[0_0_14px_rgba(179,30,60,0.9)] transition-all duration-300" style={{ fontFamily: "'Sedgwick Ave Display', cursive" }}>Sol Customs</span>
            </div>
          </button>
